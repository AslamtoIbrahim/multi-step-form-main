...
function App() {
  ...
  return (
    <div
      className="h-screen pt-8 md:py-8 font-ubun bg-blue-400/40 bg-mobile bg-contain bg-center-top bg-no-repeat
    md:bg-none  flex flex-col  md:items-center md:justify-center "
    >
      <MobileSteps />
      <div className="bg-white mx-4  rounded-lg md:rounded-xl p-5  xl:max-w-1/2 md:flex md:h-[38.5rem] lg:h-[41.5rem] ">
        <DesktopSteps />
